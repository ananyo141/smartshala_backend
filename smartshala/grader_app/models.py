...
from smartshala.test_app.models import Question, Test
...
from smartshala.school_app.models import SchoolStudent
...
class AnswerSheet(models.Model):
    ...
    test = models.ForeignKey(
        Test, on_delete=models.CASCADE, related_name="answer_test"
    )
    student = models.ForeignKey(
        SchoolStudent,
        null=True,
